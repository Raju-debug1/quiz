...
<form action="quiz.jsp">
  <table border="0" align="center" class="quest">
    ...
    <tr><td><input type="radio" name="ans" value="<%= answer[numb][0] %>" /> <%= answer[numb][0] %></td></tr>
    <tr><td><input type="radio" name="ans" value="<%= answer[numb][1] %>" /> <%= answer[numb][1] %></td></tr>
    <tr><td><input type="radio" name="ans" value="<%= answer[numb][2] %>" /> <%= answer[numb][2] %></td></tr>
    <tr><td><input type="radio" name="ans" value="<%= answer[numb][3] %>" /> <%= answer[numb][3] %></td></tr>
